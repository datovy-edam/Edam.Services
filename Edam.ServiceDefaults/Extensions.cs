...
// health checks, and OpenTelemetry.  This project should be referenced by each
// service project in your solution.  To learn more about using this project,
        ...
        builder.Services.AddOpenTelemetry()
            ...
            .WithTracing(tracing =>
            {
                tracing.AddAspNetCoreInstrumentation()
                    ...
                    // OpenTelemetry.Instrumentation.GrpcNetClient package)
